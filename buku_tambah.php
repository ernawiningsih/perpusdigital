				...
				<form method="post">
					<?php 
						if(isset($_POST['submit'])) {
							...
							$query = mysqli_query($conn, "INSERT INTO buku(id_kategori,judul,penulis,penerbit,tahun_terbit,deskripsi) values ('$id_kategori','$judul','$penulis','$penerbit','$tahun_terbit','$deskripsi')");
