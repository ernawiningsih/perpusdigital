				...
				<form method="post">
					<?php 
						...
						if(isset($_POST['submit'])) {
							...
							$query = mysqli_query($conn, "UPDATE peminjaman set id_buku='$id_buku', tanggal_peminjaman='$tanggal_peminjaman', tanggal_pengembalian='$tanggal_pengembalian', status_peminjaman='$status_peminjaman' WHERE id_peminjaman=$id");
