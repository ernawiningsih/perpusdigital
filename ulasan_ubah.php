				...
				<form method="post">
					...
					$id = $_GET['id'];
						if(isset($_POST['submit'])) {
							...
							$ulasan = $_POST['ulasan'];
							$rating = $_POST['rating'];
							$query = mysqli_query($conn, "UPDATE ulasan set id_buku='$id_buku', ulasan='$ulasan', rating='$rating' WHERE id_ulasan=$id");
						...
						$query = mysqli_query($conn, "SELECT*FROM ulasan WHERE id_ulasan=$id");
